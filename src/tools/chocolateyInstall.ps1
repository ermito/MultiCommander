...
$packageName = 'MultiCommander' # arbitrary name for the package, used in messages
$installerType = 'EXE' #only one of these: exe, msi, msu
$url = 'http://multicommander.com/files/updates/MultiCommander_win32_(4.6.2.1804).exe' # download url
$url64 = 'http://multicommander.com/files/updates/MultiCommander_x64_(4.6.2.1804).exe' # 64bit URL here or remove - if installer decides, then use $url
